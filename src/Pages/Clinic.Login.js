...
const ClinicLogin = ({loggedIn, setLoggedIn}) => {
            ...
            <div className="register-right">
                <div className='section-container register-form'>
                    ...
                    <div className='password-input-container'>
                        ...
                        />
                        <button type="button" onClick={handleTogglePassword} className="password-toggle-button">
                    ...
                    <p>
                        Don't Have an Account? <Link to="/clinic/signup">Sign Up</Link>
                    </p>
                </div>
            </div>
        </div>
